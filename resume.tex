...
\textbf{Languages:} TypeScript, JavaScript, Python, R, SQL, Shell, LaTeX, HTML/CSS \\ \textbf{Web + ML Frameworks:} React, NextJs, ExpressJs, NodeJs, TensorFlow, Keras, NumPy, Scikit-learn \\
\textbf{Cloud / Tools:} HPE GreenLake Hybrid Cloud, Heroku, DigitialOcean, Docker,
PostgreSQL, MongoDB, Redis, Tableau Cloud+TabPy, Power BI, Freshworks \\
\textbf{Methods:} A/B Testing, Clustering, ANOVA, PCA, Sentiment Analysis,
