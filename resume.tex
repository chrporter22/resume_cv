\documentclass[11pt,a4paper]{article} \usepackage[a4paper,margin=1.2cm]{geometry}
\usepackage{titlesec}
\usepackage{enumitem}
\usepackage{graphicx}
\usepackage{hyperref}
...
\subsection*{Technology and Government | NJ Civil Service Competitive Titles}

\par\noindent\textbf{Administrative Analyst - Enterprise System Integration}  
\newline\textit{County of Essex, NJ – Department of Citizen Services (2022–Present)}  
\begin{itemize}
  \item Developed enterprise-level end-to-end data infrastructure and predictive
      analytics models for mainstream \texttt{Human Service} and \texttt{Housing}
      programs. Program operations; monitoring; evaluation; grant management.
\end{itemize}
...
\newline\textit{Harvard Kennedy School of Government, 2024 | Government Performance Lab}

\vspace{0.3em}

\par\noindent\textbf{Master of Public Administration}  
\newline\textit{Kean University, 2017 | Public Policy and Research Methods | Grade: Distinction}  

\vspace{0.3em}

\par\noindent\textbf{Bachelor of Arts}  
\newline\textit{Kean University, 2016 | Grade: Summa Cum Laude}  

%===================%
%  Grants & Awards  %
%===================%
\section*{Active Grants \& Awards}
\textbf{FY 2026} – N.J. DCA - Code Red Pilot Program, \$500,000 \\
\textbf{FY 2024} – U.S. HUD - Continuum of Care: Planning Project Application, \$819,636\\
\textbf{FY 2023} – N.J. DCA - Data Driven Decision Making Organizational Enhancement
Program, \$220,000
...
\textbf{Languages:} TypeScript, JavaScript, Python, R, SQL, Shell, LaTeX, HTML/CSS \\
\textbf{Web + ML Frameworks:} React/NextJs, Node.js, TensorFlow, Keras, NumPy, Scikit-learn \\
\textbf{Cloud / Tools:} HPE GreenLake, Heroku, Docker,PostgreSQL, MongoDB, Tableau+TabPy, Freshworks \\
\textbf{Data Science Methods:} A/B Testing, Clustering, ANOVA, PCA, Sentiment Analysis,
Regression, Time-Series, Geo-coding \\
