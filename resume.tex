...
\textbf{Web + ML Frameworks:} React, NextJs, ExpressJs, NodeJs, TensorFlow, Keras, NumPy, Scikit-learn \\
\textbf{Cloud / Tools:} HPE GreenLake Hybrid Cloud, Heroku, DigitialOcean, Docker,
PostgreSQL, MongoDS, Redis, Tableau Cloud+TabPy, Power BI, Freshworks \\
